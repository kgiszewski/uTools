<%@ Page Language="C#" MasterPageFile="/umbraco/masterpages/umbracoPage.Master" AutoEventWireup="true" CodeBehind="macro.aspx.cs" Inherits="uTools.Macro" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="body" runat="server">
    ...
    <umb:JsInclude ID="JsInclude2" runat="server" FilePath="/plugins/uTools/js/macro.js" PathNameAlias="UmbracoRoot" />
    <umb:JsInclude ID="JsInclude3" runat="server" FilePath="/plugins/uTools/js/tablesorter.js" PathNameAlias="UmbracoRoot" />
    <umb:CssInclude ID="CssInclude1" runat="server" FilePath="/plugins/uTools/css/macro.css" PathNameAlias="UmbracoRoot" />
